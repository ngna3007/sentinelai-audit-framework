"""
General Recursive Chunking Processor using Chonkie

This processor implements recursive chunking of documents using the chonkie library.
It processes markdown documents and creates semantically meaningful chunks that can be
converted to CSV format for vector database ingestion and RAG applications.
...
class GeneralRecursiveChunkingProcessor:
    """
    General-purpose processor for documents using recursive chunking via chonkie library.
    
    This processor:
    1. Loads markdown documents
    2. Applies text preprocessing to clean artifacts
    3. Applies recursive chunking using chonkie
    ...
    def chunk_document(self, markdown_path: str, source: str = None) -> ChunkingResult:
        ...
        try:
            ...
            metadata = {
                ...
                'overlap_percentage': self.overlap
            }
...
def chunk_document(markdown_path: str, output_dir: str, 
    ...
    """
    Convenience function to chunk any document.
