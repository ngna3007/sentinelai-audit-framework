#!/usr/bin/env python3
"""
CSV Generator for Database Import
...
class CSVGenerator:
    def __init__(self, controls_dir: str = None, output_dir: str = None):
        ...
        if controls_dir is None:
            # Go up from core/ to pci_dss_v4_0_1/ to extractors/ to data_pipeline/ to project root/
    ...
    def load_control_data(self) -> List[Dict]:
        ...
        for prod_file in sorted(production_files):
            ...
            control_data = {
                ...
                'metadata': json.dumps(metadata['metadata'])  # Convert metadata dict to JSON string for CSV
            }
